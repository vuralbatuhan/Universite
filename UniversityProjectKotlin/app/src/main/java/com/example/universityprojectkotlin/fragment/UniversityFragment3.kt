...
import com.example.universityprojectkotlin.service.UniversityAPI3
...
class UniversityFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.fab.setOnClickListener {
            Navigation.gecis(it,R.id.action_universityFragment3_to_anaSayfaFragment)
        }

        binding.imageFavourite.setOnClickListener {
            Navigation.gecis(it,R.id.action_universityFragment3_to_favouriteUniversityFragment)
        }
    ...
    private fun loadData() {
        val retrofit = Retrofit.Builder()
            ...
            .build()
        val service = retrofit.create(UniversityAPI3::class.java)
