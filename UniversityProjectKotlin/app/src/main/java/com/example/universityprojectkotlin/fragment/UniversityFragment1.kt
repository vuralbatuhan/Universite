...
import com.example.universityprojectkotlin.service.UniversityAPI1
...
class UniversityFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.fab.setOnClickListener {
            Navigation.gecis(it,R.id.action_universityFragment1_to_universityFragment2)
        }

        binding.imageFavourite.setOnClickListener {
            Navigation.gecis(it,R.id.action_universityFragment1_to_favouriteUniversityFragment)
        }
    ...
    private fun loadData() {
        val retrofit = Retrofit.Builder()
            ...
            .build()
        val service = retrofit.create(UniversityAPI1::class.java)
